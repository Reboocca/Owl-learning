...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2017 at 03:21 PM
...
CREATE TABLE IF NOT EXISTS `toetsplanning` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lesonderwerpid` int(11) NOT NULL,
...
(14, 1, 'leerling', '2017-01-18', 'Optellen', 1, 2),
...
CREATE TABLE IF NOT EXISTS `toetsresultaten` (
  `ToetsResultaatID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Toets resultaat id',
  `UserID` int(11) NOT NULL COMMENT 'User id',
  `LesonderwerpID` int(11) NOT NULL COMMENT 'Lesonderwerp id',
  `Resultaat` int(11) NOT NULL COMMENT 'Het cijfer/resultaat',
  PRIMARY KEY (`ToetsResultaatID`)
...
CREATE TABLE IF NOT EXISTS `voortgang` (
  `VoortgangID` int(11) NOT NULL AUTO_INCREMENT,
  `UserID` int(10) NOT NULL,
  `LesID` int(10) NOT NULL,
  `LesonderwerpID` int(11) NOT NULL,
  `Voortgang` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`VoortgangID`)
